...
import Logo from "../../assets/image/logos-software/logo-horizontal-white.png";
...
export default function Header() {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-40 mx-auto max-w-7xl px-6 lg:px-8 text-white">
      <nav
      ...
      >
        <div className="flex lg:flex-1">
          <Link to="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Jizan</span>
